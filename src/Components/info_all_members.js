...
const FINTECH_MEMBERS = [
    ...
    },
    {
        ...
        bio:
            "陳縕儂 (Yun-Nung Vivian Chen) 現為國立台灣大學資訊工程學系助理教授，2015 年於美國卡內基美隆大學之電腦科學院獲頒博士學位，而後加入美國微軟研究院之深度學習科技中心任研究職務。研究專長包含對話系統、語言理解、以及深度學習，曾獲 Google Faculty Award、傑出人才年輕學者創新獎、科技部年輕學者獎及多次最佳論文獎。欲瞭解陳博士的研究及經歷，請至她的個人網頁 <a href=http://vivianchen.idv.tw>http://vivianchen.idv.tw</a>。",
        avatar:
            '/yun-nung-chen.png',
    },
];
